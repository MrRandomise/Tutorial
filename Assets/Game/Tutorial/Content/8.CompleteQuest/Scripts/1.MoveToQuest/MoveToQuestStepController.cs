...
{
    [AddComponentMenu("Tutorial/Step «Move To Quest»")]
    public sealed class MoveToQuestStepController : TutorialStepController, IGameInitElement
    {
        ...
        private readonly MoveToQuestInspector actionInspector = new();

        [SerializeField]
        private CompleteQuestConfig config;

        [SerializeField]
        private MoveToQuestPanelShower actionPanel;

        [SerializeField]
        private Transform pointerTransform;

        [SerializeField]
        private QuestPopupShower popupShower;
