...
{
    [AddComponentMenu("Tutorial/Step «Quest Popup»")]
    public sealed class QuestPopupController : TutorialStepController
    {
        private readonly QuestInspector questInspector = new();
        ...
        {
            var upgradesManager = context.GetService<MissionsManager>();
        ...
        private void OnQuestFinished()
        {
            ...
            Debug.Log(closeCursor.activeSelf);
